...
describe('Create Voucher with Assertions', () => {
    ...
    it('should ensure the voucher page loads with all elements visible', () => {
        ...
        cy.get('#abp-modal-header').should('be.visible').and('contain.text', 'New Voucher');

        // 15. Assert voucher type dropdown
        cy.get('#voucher-type').should('be.visible').and('contain.text', 'Select Voucher Type');
    ...
    it('should display an error when required field is empty', () => {
